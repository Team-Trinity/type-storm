...
export default function TypeBox() {
    ...
    return (
        <div className="flex h-screen w-full flex-col items-center justify-center gap-10 transition-all">
            <TextSelector />
            <div className=" flex w-[1000px] items-center justify-around">
            ...
            <div
                className={cn(
                    "relative w-[1000px] p-5 text-lg font-semibold transition-all",
